#!/bin/bash
# Security Enhancement Script: Moving API Token out of the Web Root

# =========================================================
# CONFIGURATION (သင်၏ မှန်ကန်သော Config များ)
# =========================================================
WEB_ROOT="/var/www/html"
CONFIG_DIR="/etc/app-config"
CONFIG_FILE="${CONFIG_DIR}/cloudflare_config.php"

# ယခင်မှန်ကန်ခဲ့သော Token/Config များကို ဤနေရာတွင် ထည့်သွင်းသည်။
...
echo "========================================================"
echo "  Step 1: Creating Secure Config Directory & File "
echo "========================================================"
...
<?php
// ${CONFIG_FILE}
// Cloudflare API Token ကို Web Root အပြင်ဘက်တွင် လုံခြုံစွာ သိမ်းဆည်းသည်။
return [
    'API_TOKEN' => '${API_TOKEN}',
    'ZONE_ID' => '${ZONE_ID}',
    'DOMAIN' => '${DOMAIN}',
...
echo "========================================================"
echo "  Step 2: Setting File Permissions for Security "
echo "========================================================"

# 2.1. ဖိုင်ပိုင်ရှင်ကို Apache user (www-data) သို့ ပြောင်းလဲခြင်း
sudo chown www-data:www-data "${CONFIG_FILE}"

# 2.2. www-data ကသာ ဖတ်နိုင်စေရန် (400) သတ်မှတ်ခြင်း (Highest Security)
...
echo "========================================================"
echo "  Step 3: Rewriting process.php to use the Config File "
echo "========================================================"

# process.php ၏ Configuration အပိုင်းကို ပြင်ဆင်ခြင်း
...
if (\$_SERVER['REQUEST_METHOD'] !== 'POST' && \$action !== 'delete') { // allow delete from GET request if needed (optional)
    if (\$action === 'manage') {
...
echo "========================================================"
echo "  Step 4: Rewriting list.php to use the Config File   "
echo "========================================================"

# list.php ၏ Configuration အပိုင်းကို ပြင်ဆင်ခြင်း
...
echo "========================================================"
echo "  Step 5: Restarting Apache Server "
echo "========================================================"
sudo systemctl restart apache2

echo "========================================================"
echo "✅ လုံခြုံရေး မြှင့်တင်ခြင်း ပြီးဆုံးပါပြီ။"
echo "API Token ကို Web Root အပြင်ဘက် ${CONFIG_FILE} သို့ ရွှေ့လိုက်ပါပြီ။"
